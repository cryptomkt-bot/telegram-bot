...
def register_handlers(dispatcher):
    ...
    dispatcher.add_handler(CommandHandler("alerta", handlers.add_alert, filters=(~ Filters.group)))
    dispatcher.add_handler(CommandHandler("alertas", handlers.alert_list, filters=(~ Filters.group)))
